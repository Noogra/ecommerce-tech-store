    ...
    <div className="relative">
      ...
      {showDropdown && (
        <>
          ...
          <div className="absolute left-0 top-12 w-80 bg-white rounded-xl shadow-2xl border border-gray-100 z-50 animate-in fade-in zoom-in duration-200">
            ...
            <div className="p-4">
              {unreadCount === 0 ? (
                <p className="text-sm text-muted text-center py-4">No new notifications</p>
              ) : (
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <p className="text-xs text-muted mt-0.5">
                      Click to view in the Orders page
                    </p>
                  </Link>
                </div>
              )}
