...
import { Package, CheckCircle, Star, Tag, ShoppingCart, DollarSign, AlertTriangle } from 'lucide-react';
  ...
  return (
    <div>
      ...
      {!loading && products.length > 0 && (
        <div className="mt-10">
          <h2 className="text-lg font-semibold text-primary mb-4">Recent Products</h2>
